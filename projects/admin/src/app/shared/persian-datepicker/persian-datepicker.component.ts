...
export class PersianDatepickerComponent {
  ...
  constructor() {
    afterNextRender(() => {
      // Dynamically import ESM web component to ensure registration in browser
  ...
  private syncElementValue(el: HTMLElement & { setValue?(y: number, m: number, d: number): void }): void {
    ...
    // 1. If we have an ISO date (e.g. "2026-10-07")
    ...
    // 2. If we have a Persian value (e.g. "1405/07/15" or "۱۴۰۵/۰۷/۱۵")
